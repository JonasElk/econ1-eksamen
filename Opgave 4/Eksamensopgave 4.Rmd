...
screenreg(list(LPM=robust_ols, ape_logit = ape_logit, ape_probit = ape_probit), digits = 4)
```
...
I dette tilfælde er foreign en binær variabel, og derfor udregnes APE manuelt.
...
APE er at foretrække, da PEA tager den partielle effekt ved gennemsnittet af variablen. Det vil være at kigge på en gennemsnitlig person, hvilket ikke nødvendigvis er realistisk. APE tager den partielle effekt af alle observationer, og tager efterfølgende gennesnit af dette.
