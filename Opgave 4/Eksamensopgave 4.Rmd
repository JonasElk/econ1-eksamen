...
Hvor $G$ angiver en funktion af regressionsmodellen. For en logit-model er denne model givet ved funktionen $$\frac{exp(z)}{1+exp(z)}$$


For en probit-model er funktionen i stedet givet ved $$\int_{-\infty}^{z}\frac{1}{\sqrt{2\pi}}exp(\frac{-z^2}{2})du$$
