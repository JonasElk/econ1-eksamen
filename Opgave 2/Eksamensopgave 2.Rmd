...
Målet med en OLS-regression er at minimere "sum of squared residuals, SSR" givet ved $$SSR = \sum_{i=n}^{n}(\hat{u}_i)^2$$. Jo større SSR, des mindre passer dataen til den estimeret model. Dermed vil man med en OLS-regression minimere følgende funktion.
...
Derudover angiver "log(salbegin)" at ved en 1% stigning (under antagelse at de resterende variable holdes konstant) i begyndelseslønnen vil medføre en approksimeret stigning på 0,82% i lønnen. 
