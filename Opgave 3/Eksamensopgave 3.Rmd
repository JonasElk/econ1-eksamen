...
summary(model)
```
I ovenstående model ses det hvordan hispanics, som den eneste variabel, er insignifikant med en p-værdi på 33,2\%. De resterende værdier er på 1\% eller lavere. Desuden er p-værdien meget lav, og dermed fortæller F-testen, at variablene er "jointly significant". Da den uafhængige variabel er i logaritmisk form skal alle Afslutningsvist ses det hvordan $R^2$ er relativt lav. 
